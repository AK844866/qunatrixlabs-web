          ...
          <div className="flex lg:flex-row flex-col-reverse lg:gap-20 gap-6 items-center container mx-auto relative z-20 h-full lg:px-0 px-6  ">
            <div className="text-left  text-white space-y-8  w-full">
              <div className="space-y-4  ">
                ...
                > Growth needs credibility. Verifide unites proof, people, and
                  possibilities through a verified digital passport—empowering
                  individuals, startups, and institutions to access real
                  opportunities. 
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 40 }}
                ...
                >
                  ...
                  <p> Gain exposure to emerging technologies.</p>
                </motion.div>
                ...
                >
                  ...
                  <p> Collaborate, learn, and grow within a verified community.</p>
                </motion.div>
              </div>
            </div>
