...
"[project]/Qunatrix/qunatrixlabs-web/app/case-studies/CaseStudiesContent.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CaseStudiesContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Qunatrix$2f$qunatrixlabs$2d$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CaseStudiesContent.useEffect": ()=>{
            let result = caseStudies;
            if (activeCategory !== "all") {
                result = result.filter({
                    "CaseStudiesContent.useEffect": (item)=>item.category === activeCategory
                }["CaseStudiesContent.useEffect"]);
            }
            if (searchQuery.trim() !== "") {
                result = result.filter({
                    "CaseStudiesContent.useEffect": (item)=>item.title.toLowerCase().includes(searchQuery.toLowerCase()) || item.subtitle.toLowerCase().includes(searchQuery.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.toLowerCase())
                }["CaseStudiesContent.useEffect"]);
            }
...
_s(CaseStudiesContent, "DkGmvajLHQbMgDO0FwH1PSVuYys=");
_c = CaseStudiesContent;
var _c;
__turbopack_context__.k.register(_c, "CaseStudiesContent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Qunatrix_qunatrixlabs-web_48f60490._.js.map