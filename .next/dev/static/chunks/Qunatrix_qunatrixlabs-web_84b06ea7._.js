...
"[project]/Qunatrix/qunatrixlabs-web/app/services/ServicesContent.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "ServicesContent.useEffect": ()=>{
            ...
            if (activeCategory !== "all") {
                result = result.filter({
                    "ServicesContent.useEffect": (item)=>item.category === activeCategory
                }["ServicesContent.useEffect"]);
            }
            if (searchQuery.trim() !== "") {
                result = result.filter({
                    "ServicesContent.useEffect": (item)=>item.title.toLowerCase().includes(searchQuery.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.toLowerCase())
                }["ServicesContent.useEffect"]);
            }
...
_s(ServicesContent, "tgIMWsSAfD4F/B8sdHpOAov/yik=");
_c = ServicesContent;
var _c;
...
//# sourceMappingURL=Qunatrix_qunatrixlabs-web_84b06ea7._.js.map